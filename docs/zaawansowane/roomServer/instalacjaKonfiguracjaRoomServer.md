...
6. Jeśli nastąpi połączenie, to naszym oczom ukaże się taka strona:
    ...
    <img src="/zaawansowane/roomServer/img/instalacjaKonfiguracjaRoomServer/5.webp" width="600px">
      ...
      - **New Admin password** - hasło administratora. Służy do logowania się jako administrator i do zdalnego zarządzania. Ustaw takie, aby nie dało się łatwo go odgadnąć. 
